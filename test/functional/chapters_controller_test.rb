...
class ChaptersControllerTest < ActionController::TestCase
  ...
  test "should create chapter" do
    assert_difference('Chapter.count') do
      post :create, chapter: { description: @chapter.description, language: @chapter.language, name: @chapter.name }
    end
  ...
  test "should update chapter" do
    put :update, id: @chapter, chapter: { description: @chapter.description, language: @chapter.language, name: @chapter.name }
    assert_redirected_to chapter_path(assigns(:chapter))
  end
